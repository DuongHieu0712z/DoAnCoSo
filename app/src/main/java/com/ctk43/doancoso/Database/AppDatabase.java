...
//            jobDetailDAO.insert(new JobDetail(1,"Học lý thuyết trường","Thêm 1 xíu về gì gì đó",5 ));
//            jobDetailDAO.insert(new JobDetail(1,"Học lý trường trọng lực","Thêm 1 xíu về gì gì đó",7 ));
//            jobDetailDAO.insert(new JobDetail(1,"Học lý thuyết trường kinh tế","Thêm 1 xíu về gì gì đó",6 ));
//            jobDetailDAO.insert(new JobDetail(2,"Học lý luận cùn","Thêm 1 xíu về gì gì đó",1 ));
//            jobDetailDAO.insert(new JobDetail(3,"làm không chơi kỳ lạ","Thêm 1 xíu về gì gì đó",3 ));
//            jobDetailDAO.insert(new JobDetail(4,"Chơi không làm","Thêm 1 xíu về gì gì đó",4 ));
            return null;
