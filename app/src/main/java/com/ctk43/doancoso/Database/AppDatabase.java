...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static class SampledData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jobDAO.insert(new Job(1, "Cua kỳ cục", "Đây là công việc đầu 1 rat nhieu chu", start, end, 4, 0.0));
            jobDAO.insert(new Job(1, "Android", "Đây là công việc đầu 1 rat nhieu chu", start, end, 3, 0.0));
            jobDAO.insert(new Job(1, "Em ăn cơm chưa", "Đây là công việc đầu 1 rat nhieu chu", start, end, 2, 0.0));
            jobDAO.insert(new Job(1, "Em ăn uống rồi", "Đây là công việc đầu 1 rat nhieu chu", start, end, 0, 0.0));
